...
ensure we have all the necessary information to effectively respond to your bug report
or contribution.
...
3. Ensure local tests pass (`python3 -m unittest discover -s tests` and
...
Looking at the existing issues is a great way to find something to contribute on. As
our projects, by default, use the default GitHub issue labels
...
See the [LICENSE](LICENSE) file for our project's licensing. We will ask you to confirm
